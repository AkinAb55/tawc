Hello! This project is Tess's Android Wayland Compositor (tawc). It's an Android app and set of rootfs-build scripts to run desktop Linux programs on Android.
